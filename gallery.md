...
<section class="section-pad reveal"><div class="container gallery-grid">{% for image in site.data.gallery %}<img src="{{ image.src }}" alt="{{ image.alt }}" loading="lazy">{% endfor %}</div></section>
